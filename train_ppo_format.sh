...
export EXPERIMENT_NAME=${data_name}-search-r1-ppo-qwen2.5-3b-it-em-structureformat-step
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_format \
    ...
    trainer.default_hdfs_dir=null \
    trainer.default_local_dir=/home/pxw240002/Search-R1/verl_checkpoints/verl_checkpoints/$EXPERIMENT_NAME \
